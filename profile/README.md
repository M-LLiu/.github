...
## 研究领域
  ...
  5. 医学图像智能分析
     ...
     - 细胞检测、分割与分类
       - **Sample hardness based gradient loss for long-tailed cervical cell detection (MICCAI 2022)**  [[code]([https://github.com/CVI-SZU/](https://github.com/M-LLiu/Grad-Libra))]
